...
<div style="float:left" id="navitem"><a href="#martial">Martial Activities<a></div>
<div style="float:left" id="navitem"><a href="#arts">Arts &amp; Sciences Activities</a></div>
<div style="float:left" id="navitem"><a href="#classes">Classes</a></div>
<div style="float:left" id="navitem"><a href="#cost">Cost</a></div>
<div style="float:left" id="navitem"><a href="#site">Site</a></div>
<div style="float:left" id="navitem"><a href="#feast">Feast</a></div>
<div style="float:left" id="navitem"><a href="#registration">Registration</a></div>
<div style="float:left" id="navitem"><a href="#map">Directions and Map</a></div>
<br style="clear: navitem;" />
</div>
...
<div id="contents"> 
<br>
<center><img src='flag.jpg' class='bflag'></center>
<br>
<h3><a id="martial">Martial Activities:</a></h3>
<div>As combat is not gem&uuml;tlich, no martial activities are planned.</div>

<h3><a id="arts">Arts &amp; Sciences Activities:</a></h3>
<div>Please contact Lady Khiba' al-Jabaliyya if you would like to teach a class (Linda Needham; cat.the.elf[AT]gmail.com; (540)471-7253 NLT 10:00)</div>

<h4><a id="classes">Class List:</a></h4>
<div>See <a href='gemutlich2_classes.php'>details page</a> for descriptions and enrollment limits.</div>
<ul>
<li>German Mead Hall Etiquette - Mistress Sorcha Crowe</li>
<li>A History of German Beer Laws - Mistress Sorcha Crowe</li>
<li>Early 16th Century German Peasant Clothing - Mistress Amie Sparrow </li>
<li>Period German Beer and Brewing</li>
<li>Russian Mead from the Domostroi - Lord Mikhail Novgorodets </li>
<li>Tyl Eulenspiegel - Lord Njall Thorvaldsson</li>
<li>Writing Your Character Story - Lord Mungo Napier</li>
</ul>

<h3><a id="cost">Cost:</a></h3>
<div>
    <table id="cost">
	...
	<h4>Acceps Registration</h4>
	<div><a href='http://acceps.ansteorra.org/regit/event_main.php'>Register online</a></div>
...
<h3><a id="feast">Feast Information:</a></h3>
<div>
    A full and hearty feast of traditional German food will be served. You MUST pre-register for feast; there will be no feast spots available at the gate.<br>
	
	<div>See <a href='gemutlich2_feast.php'>feast details page</a> for complete menu.</div>
<br>
Coffee, tea, and lemonade will be available through the day.
</div>
...
<h3><a id="reservations">Reservations:</a></h3>
<div>
Lady Elena Modarova vnuka (Karolyn McNeely), 131 Crompton Road, Waynesboro, VA 22980,  Phone: (540) 471-1401, E-mail:  dorathalia[AT]yahoo.com<br />
	...
	<h4>Acceps Registration</h4>
	<div><a href='http://acceps.ansteorra.org/regit/event_main.php'>Register online</a></div>
<h3><a id="map">Directions &amp; map:</a></h3>
<div>
